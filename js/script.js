...
const cplusBar = document.querySelector('.bar-cplus')
...
t1.fromTo(htmlBar, .75 , {width: `calc(0% - 6px)`}, {width: `calc(90% - 6px)`, ease: Power4.easeOut})
    ...
    .fromTo(cplusBar, .75 , {width: `calc(0% - 6px)`}, {width: `calc(70% - 6px)`, ease: Power4.easeOut})
    .fromTo(pythonBar, .75 , {width: `calc(0% - 6px)`}, {width: `calc(60% - 6px)`, ease: Power4.easeOut})
